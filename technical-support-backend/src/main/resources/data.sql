...
INSERT INTO device_type(title)
VALUES ('Монитор'),
       ('Комплект б.п. клавиатура и мышь'),
       ('Док-станция'),
       ('Гарнитура'),
       ('Ноутбук');

INSERT INTO employee(staff_number, birth_day, email, first_name, middle_name, last_name, password, phone_number,
                     is_online, role, department_id, job_post_id, workplace_id)
VALUES (nextval('employee_seq'), '2002-01-31', 'shishkin@mail.ru', 'Артем', 'Игоревич', 'Шишкин',
        '$2a$12$Z3qq3W15pwNxB5VgvhD28u7DKwxP6CJFmzNc802xf2hps9lmbis9m', '89113235670', false, 'EMPLOYEE', 3, 2, 1),
       (nextval('employee_seq'), '1999-01-31', 'ivanov@mail.ru', 'Иван', 'Иванович', 'Иванов',
        '$2a$12$TEZ/WIzEsl0AR8kbCUz7P.fC6jY1q8KiC4BOVkNPW65gsTBvRA/aO', '89113235670', false, 'SUPPORT', 3, 2, 7),
       (nextval('employee_seq'), '2000-05-23', 'katkov@mail.ru', 'Евгений', 'Викторович', 'Катков',
        '$2a$12$yvw49zR3BrDO0qQ7jX5U4ujQ5l15kYuAIqFXOODAD.rEc54H4NaOy', '89153115283', false, 'SUPPORT', 1, 2, 2),
       (nextval('employee_seq'), '1993-04-07', 'admin@mail.ru',  'Алексей', 'Алексеевич', 'Алексеев',
        '$2a$12$.1JwVpq1OtbAw4UzSCmCouB4tiffptEG9DVK/HS55ErbUCzeHsSfu', '89231112244', false, 'ADMIN', 3, 3, 3);
...
VALUES ('2023-05-16 15:36:38', 'Не открывается программа', '2023-05-30 15:36:38', false, null, 10000001, 10000000, 1,
        1),
       ('2023-05-16 16:22:17', 'Автоматическое закрытие программы спустя пару часов работы', '2023-05-16 16:22:17',
        false, null, 10000001, 10000001, 1, 1),
       ('2023-05-17 12:23:17', 'Не работает микрофон', '2023-05-31 12:23:17', false, null, 10000001, 10000000, 2, 1),
       ('2023-05-17 15:00:17', 'При входе в ПК выдает ошибку, что не удалось подключиться к серверу',
        '2023-05-31 15:00:17', true, null, 10000002, 10000001, 3, 1);
...
INSERT INTO employee(staff_number, birth_day, email, first_name, middle_name, last_name, password, phone_number,
                     is_online, role, department_id, job_post_id, workplace_id)
VALUES (nextval('employee_seq'), '1993-04-07', 'admin@mail.ru',  'Алексей', 'Алексеевич', 'Алексеев',
        '$2a$12$.1JwVpq1OtbAw4UzSCmCouB4tiffptEG9DVK/HS55ErbUCzeHsSfu', '89231112244', false, 'ADMIN', 3, 3, 3)
